          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <Dialog>
                  ...
                  <DialogContent className="max-w-4xl max-h-[90vh] overflow-auto">
                    ...
                    <div className="mt-4 space-y-4">
                      <img src="/assets/resume1.png" alt="Hari Chander Naik Resume - Page 1" className="w-full h-auto rounded-lg shadow-lg" />
                      <img src="/assets/resume2.png" alt="Hari Chander Naik Resume - Page 2" className="w-full h-auto rounded-lg shadow-lg" />
                      <img src="/assets/resume3.png" alt="Hari Chander Naik Resume - Page 3" className="w-full h-auto rounded-lg shadow-lg" />
                    </div>
                  </DialogContent>
                </Dialog>
            ...
            delay: 0.2
              ...
              <div className="relative">
                ...
                <img src="/assets/profile.jpg" alt="Hari Chander Naik" className="relative w-80 h-80 rounded-full object-cover shadow-2xl" />
              </div>
            </motion.div>
          </div>
        </div>
